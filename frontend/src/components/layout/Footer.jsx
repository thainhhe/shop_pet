        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              ...
              thú cưng. Tìm kiếm, mua bán và nhận nuôi thú cưng một cách an toàn
              và minh bạch.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/pets" className="text-gray-300 hover:text-white">
                  Thú cưng
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/adoption" className="text-gray-300 hover:text-white">
                  Nhận nuôi
                </a>
              </li>
              <li>
                <a href="/community" className="text-gray-300 hover:text-white">
                  Cộng đồng
                </a>
              </li>
            </ul>
