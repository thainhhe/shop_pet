...
import ShopOrderManagement from "../components/admin/ShopOrderManagement";
...
function ShopDashboard() {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      // This endpoint should return orders for this shop's products/pets
      const res = await api.get("/shop/orders", config);
  ...
  const tabItems = [
    {
      ...
      label: (
        <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <AppstoreOutlined style={{ fontSize: 20 }} /> Tổng quan
        </span>
      ),
      children: (
        <>
    ...
    },
    {
      ...
      label: (
        <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <ShoppingOutlined style={{ fontSize: 20 }} /> Quản lý đơn hàng
        </span>
      ),
      children: <ShopOrderManagement />,
    },
  ];
